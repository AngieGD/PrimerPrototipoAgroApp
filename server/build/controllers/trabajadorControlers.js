...
class TrabajadorControlers {
    listar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const traba = yield database_1.default.query('SELECT * FROM trabajador');
            res.json(traba);
    ...
    listarUno(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const trabajador = yield database_1.default.query('SELECT * FROM trabajador WHERE trabajadorId = ?', [id]);
    ...
    eliminar(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            yield database_1.default.query('DELETE FROM trabajador WHERE trabajadorId = ?', [id]);
...
exports.default = trabajadorcontrolers;
